...
async def main():
    ...
    test_users = [
        {"id": "a8098c1a-f86e-11da-bd1a-00112444be1e", "name": "user1", "messages": [("telegram", 5), ("whatsapp", 2)]},
        {"id": "b9098d2b-f86e-11da-bd1a-00112444be2e", "name": "user2", "messages": [("telegram", 3), ("email", 4)]},
        {"id": "c9098e3c-f86e-11da-bd1a-00112444be3e", "name": "user3", "messages": [("whatsapp", 6), ("viber", 1)]},
        {"id": "d9098f4d-f86e-11da-bd1a-00112444be4e", "name": "user4",
         "messages": [("telegram", 2), ("whatsapp", 3), ("email", 1)]},
        {"id": "e9098f5e-f86e-11da-bd1a-00112444be5e", "name": "user5", "messages": [("viber", 7)]}
    ]
    ...
    for user_data in test_users:
        try:
            ...
            print(f"Ошибка создания пользователя {user_data['name']}: {e}")
            continue
